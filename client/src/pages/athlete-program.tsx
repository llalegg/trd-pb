...
import SummaryView from "@/components/athlete-program/SummaryView";
	...
	return (
		<div className="min-h-screen bg-surface-base font-['Montserrat'] relative">
			...
			<div className="pt-14 transition-[margin-left] duration-300" style={{ marginLeft: detailsOpen ? detailsPanelWidth : 0 }}>
				{currentTab === "summary" && (
					<SummaryView athleteId={athleteId!} athleteName={athleteData?.athlete.name} onNavigateTab={handleTabChange} />
				)}
