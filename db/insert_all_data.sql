...
('block-3-4', 'athlete-3', 'phase-athlete-3', 4, 'In-Season Block 2', '2025-10-13', '2025-11-20', 5, 'In-Season', 'Mid', 'pending-signoff', '{"week":3,"day":2}', '{"xRole":"Starter","phase":"In-Season"}', '{"intensity":"Moderate","volume":"Low"}', '{"split":"2x2","emphasis":"Maintenance","variability":"High","scheme":"Undulating"}', NULL, '2025-11-17 00:00:00', '2025-10-10 00:00:00', '2025-11-17 00:00:00')
ON CONFLICT (id) DO NOTHING;
...
('block-4-3', 'athlete-4', 'phase-athlete-4', 3, 'Pre-Season Block 3', '2025-11-26', '2025-12-24', 4, 'Pre-Season', 'Late', 'pending-signoff', '{"week":1,"day":1}', '{"xRole":"Starter","phase":"Pre-Season"}', '{"intensity":"High","volume":"Moderate"}', '{"split":"3x2","emphasis":"Power","variability":"Medium","scheme":"Undulating"}', '2025-11-17 00:00:00', '2025-11-13 00:00:00', '2025-11-17 00:00:00')
ON CONFLICT (id) DO NOTHING;
